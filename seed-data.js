...
(async function seed() {
  if (typeof state === 'undefined' || !state.currentUser) {
    console.error(
      '❌ Debes estar logueado en admin.html. state.currentUser =',
  ...
  for (let i = 0; i < oldTeamIds.length; i += 10) {
    ...
    totalResp += await deleteQuery(db.collection('respuestas').where('equipoId', 'in', chunk));
  }
  ...
  const COMMENTS = {
    fenix: {
      1: {
        // Q2
        1: {
          backlog: 'El backlog empieza a tomar forma, pero el Product Goal todavía no es conocido por todos los devs.',
        },
      ...
      2: {
        ...
        0: {
          eventos:
            'Las ceremonias están bien estructuradas este sprint. Sin embargo, las retros siguen siendo un teatro: acordamos acciones pero nadie las sigue y en el próximo sprint nadie recuerda qué comprometimos.',
        },
        1: {
          backlog:
            'El product goal ya es más claro. El backlog está mejor priorizado aunque hay muchos items sin criterios de aceptación.',
        },
    ...
    titan: {
      1: {
        ...
        1: {
          devteam:
            'Con 8 devs es muy difícil coordinarse. Las dependencias entre subgrupos bloquean constantemente el flujo.',
        },
      ...
      2: {
        ...
        1: {
          devteam:
            'El equipo es demasiado grande. Los impedimentos se pierden entre subgrupos y nadie los escala realmente. Necesitamos dividir o cambiar la estructura.',
        },
        0: {
          eventos:
            'Hemos reducido el Daily a 25 minutos usando un facilitador rotativo. Es una mejora pero aún hay ruido.',
        },
        3: {
          backlog:
            'El refinamiento avanza. Los criterios de aceptación son más claros aunque aún hay trabajo por hacer.',
        },
    ...
    nova: {
      1: {
        ...
        0: {
          tecnico:
            'Las revisiones entre pares empiezan a ser parte del proceso. Todavía hay inconsistencias en los entregables.',
        },
      ...
      2: {
        ...
        0: {
          eventos:
            'Las ceremonias adaptadas a equipo de conocimiento funcionan bien. Los sprint reviews generan conversaciones de valor.',
        },
        1: { backlog: 'El product goal está claro. El backlog de conocimiento está bien priorizado por impacto.' },
        4: {
          tecnico:
            'Las revisiones entre pares ya son un hábito del equipo. La calidad de los entregables mejoró visiblemente.',
        },
        6: {
          transparencia:
            'El SM es muy proactivo escalando impedimentos. Casi ninguno dura más de 2 días sin resolverse.',
        },
      },
    },
  };
  ...
  for (const td of TEAM_DEFS) {
    ...
    for (const ci of td.ciclosIdx) {
      ...
      console.log(
        `    Ciclo ${ci + 1} (${cycle.nombre}): ${td.respondents.length} resp · ~${pctApprox}% ${getLevelLabel(pctApprox)}`
      );
    }
  }
  ...
  const PLAN_DEFS = [
    // Fénix — equipo pequeño mejorando, foco en ceremonias y cliente
    {
      ...
      planes: [
        {
          iniciativa: 'Implementar acuerdos de trabajo al inicio de cada sprint',
          responsable: 'Scrum Master',
          estado: 'completado',
          dimension: 'eventos',
          fechaObjetivo: '2025-09-15',
        },
        {
          iniciativa: 'Definir y comunicar el Product Goal a todo el equipo',
          responsable: 'Product Owner',
          estado: 'en-curso',
          dimension: 'backlog',
          fechaObjetivo: '2025-10-31',
        },
        {
          iniciativa: 'Establecer sesiones quincenales de feedback con usuarios',
          responsable: 'Product Owner',
          estado: 'pendiente',
          dimension: 'cliente',
          fechaObjetivo: '2025-11-30',
        },
      ],
    },
    // Orión — equipo maduro optimizando
    {
      ...
      planes: [
        {
          iniciativa: 'Implementar Continuous Discovery con usuarios clave',
          responsable: 'Product Owner',
          estado: 'en-curso',
          dimension: 'cliente',
        ...
        {
          iniciativa: 'Alcanzar 90% de cobertura de tests automatizados',
          responsable: 'Dev Team',
          estado: 'en-curso',
          dimension: 'tecnico',
          fechaObjetivo: '2025-11-15',
        },
        {
          iniciativa: 'Documentar y socializar prácticas de ingeniería del equipo',
          responsable: 'Scrum Master',
          estado: 'pendiente',
          dimension: 'devteam',
    ...
    // Titán — equipo grande con problemas de coordinación
    {
      ...
      planes: [
        {
          iniciativa: 'Dividir el equipo en dos squads independientes de 4',
          responsable: 'Scrum Master',
          estado: 'pendiente',
          dimension: 'devteam',
          fechaObjetivo: '2026-01-31',
        },
        {
          iniciativa: 'Reducir el Daily Scrum a 15 min con agenda estructurada',
          responsable: 'Scrum Master',
          estado: 'en-curso',
          dimension: 'eventos',
          fechaObjetivo: '2025-10-31',
        ...
        {
          iniciativa: 'Crear Definition of Done compartida entre subgrupos',
          responsable: 'Product Owner',
          estado: 'pendiente',
          dimension: 'devteam',
          fechaObjetivo: '2025-11-15',
    ...
    // Nova — equipo de conocimiento consolidando
    {
      ...
      planes: [
        {
          iniciativa: 'Implementar checklist de calidad para todos los entregables',
          responsable: 'Scrum Master',
          estado: 'en-curso',
          dimension: 'tecnico',
          fechaObjetivo: '2025-10-31',
        ...
        {
          iniciativa: 'Sesión trimestral de co-diseño con clientes internos',
          responsable: 'Product Owner',
          estado: 'completado',
          dimension: 'cliente',
        ...
        {
          iniciativa: 'Crear repositorio central de conocimiento del equipo',
          responsable: 'Dev Team',
          estado: 'pendiente',
          dimension: 'backlog',
          fechaObjetivo: '2025-12-15',
