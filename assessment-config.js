...
const SECTIONS = [
  {
    id: 'eventos',
    tag: 'Sección 1 de 6',
    title: 'Ceremonias y ritmo del equipo',
    desc: 'Cómo el equipo vive los eventos definidos en la Scrum Guide',
    role: 'PO + Dev Team',
    questions: [
      {
        ...
        opts: [
          'Nunca o rara vez',
          'A veces, pero el Goal es vago',
          'Casi siempre con Goal definido',
          'Siempre; el Goal guía cada decisión del Sprint',
        ],
        weight: 1.5,
      },
      {
        ...
        opts: [
          'No hacemos Daily o es un reporte de estado',
          'Hacemos Daily pero sin foco en el Goal',
          'Mayormente nos enfocamos en el Goal',
          'El Daily es una herramienta real de adaptación diaria',
        ],
      },
      {
        text: '¿La Sprint Review involucra a stakeholders reales y genera feedback accionable?',
        opts: [
          'No hacemos Review o es solo interna',
          'Hay stakeholders pero el feedback no se incorpora',
          'A veces logramos feedback útil',
          'Siempre; los stakeholders influyen el Product Backlog',
        ],
      },
      {
        ...
        opts: [
          'No hacemos Retro',
          'Hacemos Retro pero sin compromisos concretos',
          'Definimos mejoras pero pocas se implementan',
          'Las mejoras se rastrean y se implementan sistemáticamente',
        ],
      },
    ],
  },
  {
    ...
    desc: 'Evaluación desde la perspectiva del Product Owner',
    role: 'Product Owner',
    questions: [
      {
        text: '¿El Product Backlog está ordenado por valor y refleja las necesidades reales de los usuarios?',
        opts: [
          'No está ordenado o no existe claro',
          'Está ordenado por esfuerzo o cronología',
          'Ordenado parcialmente por valor',
          'Ordenado por valor, revisado continuamente con stakeholders',
        ],
      },
      {
        text: '¿Los ítems del backlog tienen criterios de aceptación claros antes de entrar al Sprint?',
        opts: [
          'Rara vez tienen criterios',
          'Algunos tienen criterios básicos',
          'La mayoría tiene criterios antes del Sprint',
          'Todos tienen criterios claros y el equipo los revisó',
        ],
      },
      {
        text: '¿El Product Goal está definido y el equipo lo conoce?',
        opts: [
          'No existe Product Goal formal',
          'Existe pero pocos en el equipo lo conocen',
          'El equipo lo conoce pero no lo usa para tomar decisiones',
          'El Product Goal guía el refinamiento y priorización',
        ],
        weight: 1.5,
      },
    ],
  },
  {
    id: 'devteam',
    tag: 'Sección 3 de 6',
    title: 'Autoorganización y entrega',
    desc: 'Capacidades técnicas y de autogestión del equipo de desarrollo',
    role: 'Dev Team',
    questions: [
      {
        text: '¿El equipo se autoorganiza para lograr el Sprint Goal sin necesitar asignación externa de tareas?',
        opts: [
          'El líder o PM asigna todas las tareas',
          'Hay algo de autoorganización pero con dependencia externa',
          'El equipo mayormente se organiza solo',
          'Plena autoorganización; el equipo decide cómo lograr el Goal',
        ],
      },
      {
        text: '¿El Increment al final de cada Sprint cumple la Definition of Done y está potencialmente entregable?',
        opts: [
          'No tenemos Definition of Done',
          'Tenemos DoD pero rara vez se cumple',
          'Se cumple en la mayoría de Sprints',
          'Siempre; cada Sprint produce un Increment usable',
        ],
        weight: 1.5,
      },
      {
        ...
        opts: [
          'Hay muchas dependencias externas para completar ítems',
          'Dependencias frecuentes en algunas áreas',
          'Mayormente autónomo, pocas dependencias',
          'Totalmente cross-functional; entrega completa sin externos',
        ],
      },
      {
        text: '¿Qué tan bien maneja el equipo el WIP (work in progress) para evitar cuellos de botella?',
        opts: [
          'Sin límite de WIP; varios ítems empezados y sin terminar',
          'El WIP crece sin control en cada Sprint',
          'Hay cierta conciencia pero sin límites formales',
          'Limitamos WIP activamente para maximizar el flujo',
        ],
      },
    ],
  },
  {
    ...
    desc: 'Adhesión a los pilares empíricos del proceso',
    role: 'PO + Dev Team + SM',
    questions: [
      {
        text: '¿El equipo y stakeholders tienen visibilidad real del progreso y los impedimentos?',
        opts: [
          'La información está fragmentada o desactualizada',
          'Hay visibilidad parcial en algunas áreas',
          'Buena visibilidad, con algunas brechas',
          'Transparencia total; el Scrum Board refleja la realidad',
        ],
      },
      {
        text: '¿El equipo adapta su plan basándose en lo aprendido durante el Sprint?',
        opts: [
          'El plan no cambia una vez iniciado el Sprint',
          'Adaptaciones mínimas, generalmente al final',
          'Adaptaciones frecuentes con base en la evidencia',
          'Inspección y adaptación continua; el plan es una guía viva',
        ],
      },
      {
        text: '¿Los valores de Scrum (compromiso, coraje, foco, apertura, respeto) son visibles en el día a día?',
        opts: [
          'Rara vez se manifiestan en las interacciones',
          'Algunos valores están presentes de forma inconsistente',
          'La mayoría de valores se practican habitualmente',
          'Los valores son parte de la cultura del equipo',
        ],
        weight: 1.5,
      },
      {
        ...
        opts: [
          'Los impedimentos no se identifican o permanecen bloqueados varias semanas sin dueño',
          'Se mencionan en el Daily pero nadie los escala; el equipo los asume como parte del trabajo',
          'La mayoría se escalan y se resuelven, aunque algunos quedan sin seguimiento',
          'Los impedimentos se identifican, escalan y resuelven sistemáticamente antes de que bloqueen el Sprint Goal',
        ],
      },
    ],
  },
  {
    ...
    desc: 'Prácticas de ingeniería que sostienen la agilidad y la calidad de entrega',
    role: 'Dev Team',
    ...
    altQuestions: [
      {
        ...
        opts: [
          'Rara vez o nunca; el trabajo se entrega sin revisión',
          'Se revisa a veces pero sin criterios claros',
          'La mayoría del trabajo pasa por revisión de pares',
          'Revisión sistemática con criterios de calidad compartidos',
        ],
      },
      {
        text: '¿El equipo tiene criterios de aceptación claros para sus entregables?',
        opts: [
          'Los entregables no tienen criterios de calidad definidos',
          'Hay criterios informales pero inconsistentes',
          'La mayoría de entregables tiene criterios antes de empezar',
          'Criterios claros acordados en equipo; guían cada entregable',
        ],
      },
      {
        text: '¿El equipo gestiona activamente los problemas de proceso (retrabajos, inconsistencias, flujos rotos)?',
        opts: [
          'No se reconoce ni se habla de problemas de proceso',
          'Se reconoce pero no se prioriza ni se aborda',
          'Se identifican y se abordan esporádicamente',
          'La mejora del proceso es parte del ritmo habitual del equipo',
        ],
      },
    ],
    questions: [
      {
        ...
        opts: [
          'No hay CI; el build es manual o esporádico',
          'CI configurado pero con fallos frecuentes no resueltos',
          'CI estable; los fallos se resuelven antes de continuar',
          'CI + CD; despliegues automatizados frecuentes y fiables',
        ],
      },
      {
        ...
        opts: [
          ...
          'Algunas pruebas pero con cobertura muy baja',
          'Buena cobertura en áreas críticas del sistema',
          'Suite sólida de pruebas; se refactoriza y despliega con confianza',
        ],
      },
      {
        text: '¿El equipo gestiona activamente la deuda técnica?',
        opts: [
          'No se reconoce ni se habla de deuda técnica',
          'Se reconoce pero nunca se prioriza',
          'Se incluye en el backlog y se prioriza con criterio',
          'Se gestiona como parte del refinamiento y de la Definition of Done',
        ],
      },
    ],
  },
  {
    ...
    desc: 'Conexión del equipo con usuarios reales y generación de valor medible',
    role: 'PO + Dev Team',
    questions: [
      {
        text: '¿El equipo tiene contacto directo con usuarios o clientes reales?',
        opts: [
          'Nunca; todo pasa a través del PO o Management',
          'Raramente, solo en demos formales',
          'Ocasionalmente en Sprint Reviews o entrevistas puntuales',
          'Regularmente; el equipo valida hipótesis directamente con usuarios',
        ],
      },
      {
        text: '¿El equipo mide si lo que entrega genera valor real para el negocio o el usuario?',
        opts: [
          'No se mide impacto; solo se cuentan features entregadas',
          'Hay algunas métricas de negocio pero no se revisan con regularidad',
          'Seguimiento de métricas clave por producto en cada Sprint Review',
          'Cultura de experimentación: hipótesis → medición → aprendizaje',
        ],
      },
      {
        text: "¿El equipo entiende el 'por qué' de negocio detrás de cada ítem del backlog?",
        opts: [
          'Rara vez se explica el propósito de negocio de los ítems',
          'A veces, cuando se pregunta explícitamente',
          'El PO explica el valor esperado en el refinamiento',
          'El equipo cuestiona y co-diseña la solución basado en el problema real',
        ],
      },
    ],
  },
...
const LEVELS = [
  {
    ...
    color: '#c0282a',
    bg: '#fce8e8',
    desc: 'El equipo conoce Scrum en teoría pero la práctica es inconsistente. Alta dependencia de procesos externos.',
  },
  {
    max: 65,
    label: 'En desarrollo',
    color: '#a05c0a',
    bg: '#fdefd6',
    desc: 'Adopción parcial de Scrum. Los eventos ocurren pero el valor generado aún no se optimiza.',
  },
  {
    max: 82,
    label: 'Maduro',
    color: '#1a4fd6',
    bg: '#dce6ff',
    desc: 'Scrum está bien incorporado. El equipo entrega valor consistentemente y mejora de forma continua.',
  },
  {
    max: 100,
    label: 'Avanzado',
    color: '#0d7a52',
    bg: '#d4f0e5',
    desc: 'Equipo de alto rendimiento ágil. El empirismo guía cada decisión; la mejora continua es parte del ADN.',
  },
];
...
const DIMS = [
  ...
  { key: 'devteam', label: 'Dev Team', max: 12, color: '#a05c0a', field: 'Score Dev Team', storeKey: 'scoreDevTeam' },
  {
    ...
    max: 12,
    color: '#7c3aed',
    field: 'Score Transparencia',
    storeKey: 'scoreTransparencia',
  },
  { key: 'tecnico', label: 'Exc. Técnica', max: 9, color: '#0891b2', field: 'Score Técnico', storeKey: 'scoreTecnico' },
  {
    key: 'cliente',
    label: 'Orient. Cliente',
    max: 9,
    color: '#db2777',
    field: 'Score Cliente',
    storeKey: 'scoreCliente',
  },
];
...
function detectPatterns(dimScores) {
  return CROSS_PATTERNS.filter((p) => p.dims.every((k) => dimScores[k] && dimScores[k].pct < p.maxPct));
}
...
function getContextNote(dim, pct, tamano, tiempoScrum) {
  ...
  if (isNew && pct < 70) return 'Equipo nuevo: priorizar cadencia básica y rituales antes de optimizar.';
  if (isOld && pct < 50)
